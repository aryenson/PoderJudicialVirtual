...
rounded-lg shadow-lg">
  ...
  <h1 class="text-3xl text-center font-bold">Registro cliente</h1>
  ...
  <form class="mt-4" method="POST" action="">
    ...
    text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Clave"
    ...
    placeholder="Confirmar clave" id="password_confirmation" 
    name="password_confirmation">

    <button type="submit" class="rounded-md bg-indigo-500 w-full text-lg
    text-white font-semibold p-2 my-3 hover:bg-indigo-600">Aceptar</button>
